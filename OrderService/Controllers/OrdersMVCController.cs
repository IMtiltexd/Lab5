...
namespace OrderService.Controllers
{
    public class OrdersMVCController : Controller
    {
        ...
        public OrdersMVCController(OrderContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Orders != null ? 
                          ...
                          Problem("Entity set 'OrderContext.Orders'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientId,ProductId,Quantity,DateTime")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,ProductId,Quantity,DateTime")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
